...
import venus_text from '../assets/venus_text.png';
import feather from '../assets/feather.png'

class Venus extends Phaser.Scene {
    constructor() {
        super({key: 'Venus',
        physics: {
            default: 'matter',
    ...
    preload() {
        this.load.image('venus_sky', venus);
        this.load.image('ground', ground);
        this.load.image('ball', ball); 
        this.load.image('venus_text', venus_text);
    ...
    create() {
        ...
        this.background = this.add.image(400, 300, 'venus_sky');
        ...
        this.venus_text = this.add.image(200, 50, 'venus_text').setScale(0.35);
        ...
        this.feather1 = this.matter.add.image(150, 46, 'feather', null, {chamfer: 16}).setBounce(0).setCollisionGroup(this.canDrag).setFrictionAir(0.23);
